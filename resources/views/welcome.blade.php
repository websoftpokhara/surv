            ...
            <div class="row">
                <div class="col-md-12">
                    <p style="text-align: left; color: #000">नमस्कार !! <br /> 
                            ...
                            <span style="color: #000">राष्ट्रिय अपाङ्ग महासंघ नेपाल</span> <br />
                            <img class="img-fluid" src="{{ asset('site/img/header_final16122018.jpg') }}" alt=""></p>
                </div>
            </div>
            @if($language == 'np')
            <div class="row">
                                ...
                                <div id="middle-wizard">
                                    <div class="step">
                                        <div class="col-md-12" style="text-align: right;">
                                            <a href="{{route('getLanguage', 'en')}}">English</a> | <a href="{{route('getLanguage', 'np')}}">Nepali</a> | {{$language}}
                                        </div>
